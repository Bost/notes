...
theorems of EGA and SGA
finite order arithmetic
elementary topos of sets with infinity
arithmetic scheme
category of sheaves

Finite order arithmetic, or simple type theory with infinity, is n-th order
arithmetic for all finite n.

universe $\mathcal{U}$, and a simpler notion of $\mathcal{U}$-category

theory of classes and collections conservative over set theory
...
Equiconsistency of finite order arithmetic
