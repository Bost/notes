...
@block{@block-name{word mode}
}

@block{@block-name{line mode}
}

@block{@block-name{sentence mode}
}

@block{@block-name{window mode}
}

@block{@block-name{symex packake for structural lisp code editing}
