...
@block{@block-name{guix pull}
  # Update Guix OS distribution & Guix tools: download the latest Guix source
  # code and package descriptions, and deploys it. See ~/.cache/guix/checkouts
  ...
  #   which is not a descendant of <Y> hint: This could indicate that the
  #   channel has been tampered with and is trying to force a roll-back,
  #   preventing you from getting the latest updates. If you think this is not
  #   the case, explicitly allow non-forward updates.
