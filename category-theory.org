...
_Idea_: replace content of an object (picked i.e. fixed) by all arrows ending in
this object. See \href{https://youtu.be/JH_Ou17_zyU?t=1h8m9s}{youtube}.
It's content and properties.
Set of Arrow from every possible Obj $X$ to the Obj $A$.

How to map from an Obj $X$ to the Set of Arrows $X \rightarrow A$:
1. for every Obj $A$ get a different functor $F: C \rightarrow Set$
2. then vary the Obj $A$:

*** Yoneda Lemma
_Idea_: Natural transformation and functor (i.e. Container) can replace each other
...
If $F$ is (left) adjoint to $G$, then there is typically some formula of the
type $(x, Gy) \iso (Fx, y)$.
...
# % https://tikzcd.yichuanshen.de/#-Acjidzs4wiBrrd7joQI8AfVGsDsV5qpx2PjjjAzhcSWS7n8nogWnTEMZDgMhiMxliEXNkcsGmjNpiDtEvHiQR05sRKdSkMLBd0IaK2MMcDgCkqsrFvr8tf96YLJG11UgALS9A1QkAwiXwmbSxay1brBXbXY49S8gEC14OyFik1m0NedRMll8Ch8IA
\begin{center}
\begin{tikzcd}
C_1 \arrow[rrrrr, "F_1"', Rightarrow, bend left] \arrow[rdd, "m_C"'] &                                                         & GD_1 \arrow[ldd, "Gn_D", dotted] &  &                                     & D_1 = FC_1 \arrow[ldd, "n_D"] \arrow[lll, "G_1", Rightarrow] \arrow[rdd, "Fm_C", dotted] &      \\
                                                                     &                                                         &                                  &  &                                     &                                                                                          &      \\
                                                                     & C_2 = GD_2 \arrow[rrrrr, "F_2", Rightarrow, bend right] &                                  &  & D_2 \arrow[lll, "G_2"', Rightarrow] &                                                                                          & FC_2
\end{tikzcd}
\end{center}
...
examples:
- product is left adjoint to exponential: $(-) x A \ladj (-)^A$
- left adjointness of sum (coproduct), pairing and product: $Σ \ladj ∆ \ladj Π$
...
Obj in a Cat of Types such that: For every $A$, $B$ there is a set of arrows
from $A$ to $B$. This obj is called function-type. It can be defined by an
adjunction of two endofunctors. \\

$F \ladj G$ : "$F$ is left adjoint to $G$"

Edit on \href{https://tikzcd.yichuanshen.de/#-s-Rj1qdHl7tVbFTblaqdn8nSBKUKc+52O62PXWRbENsWz620qvvbuw4Ac6B67h2BUaPVGbEMHTucQ1qZ33rUZbV2Y7Isy79evN+NuEA}{tikzcd}.
\begin{center}
\begin{tikzcd}
